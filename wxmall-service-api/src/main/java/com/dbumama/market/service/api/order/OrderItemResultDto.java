...
public class OrderItemResultDto extends AbstractResultDto {
	...
	private List<ProdFullCutResultDto> fullCutDtos;			//商品满减的数据
	private String payStatus;		//支付状态，拼团的时候有值
	...
	public List<ProdFullCutResultDto> getFullCutDtos() {
		return fullCutDtos;
	}
	public void setFullCutDtos(List<ProdFullCutResultDto> fullCutDtos) {
