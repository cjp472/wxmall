...
import com.dbumama.market.service.api.order.InvTplSaveParamDto;
...
public class InvTemplateServiceImpl extends AbstractServiceImpl implements InvTemplateService {
	...
	public InvoiceTemplate getUserTpl(Long sellerId) throws OrderException {
		...
		InvoiceTemplate invoiceTemplate = invTpldao.findFirst("select * from " + InvoiceTemplate.table + " where seller_id=? ", sellerId);
		if(invoiceTemplate == null){
			invoiceTemplate = invTpldao.findFirst("select * from " + InvoiceTemplate.table + " where seller_id is null");
		}
	...
	public InvoiceTemplate save(InvTplSaveParamDto tplParamDto) throws OrderException {
		...
		InvoiceTemplate invoicetpl = invTpldao.findFirst("select * from " + InvoiceTemplate.table + " where seller_id=? ", tplParamDto.getSellerId());
