...
public class ModuleServiceImpl implements ModuleService {
	...
	public FuncResultDto getModuleFun(GetFunParamDto funParamDto) throws ModuleException {
		...
		funcResultDto.setFuncUrl("http://"+funParamDto.getAuthAppId()+".ybwqy.com" + moduleFun.getFunUrl());
		funcResultDto.setQrcode(JFinal.me().getContextPath()+"/qrcode/genio?url="+"http://"+funParamDto.getAuthAppId()+".ybwqy.com" + moduleFun.getFunUrl());
