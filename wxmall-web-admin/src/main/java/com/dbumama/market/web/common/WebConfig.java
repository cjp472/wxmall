...
import com.dbumama.market.web.core.ueditor.manager.FdfsFileManager;
...
public class WebConfig extends WxmFreekConfig {
	...
	protected void onWxMallStart() {
		configFreemarker();
		//使用fdfs图片服务器
		if("fdfs".equals(PropKit.get("file_handle_type")))
			UeditorConfigKit.setFileManager(new FdfsFileManager());
