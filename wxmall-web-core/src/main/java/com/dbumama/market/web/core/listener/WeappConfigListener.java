 ...
 * 2017年7月27日
 */
@Listener(action = {"weapp_config"})
public class WeappConfigListener extends AbstractConfig implements MessageListener{

	private AuthUserConfig authConfigDao = new AuthUserConfig().dao();
	...
	public void onMessage(Message message) {
		Weapp weapp = message.getData();
		saveWxsdkProp(authConfigDao.findFirst("select * from " + AuthUserConfig.table), weapp);
	}
