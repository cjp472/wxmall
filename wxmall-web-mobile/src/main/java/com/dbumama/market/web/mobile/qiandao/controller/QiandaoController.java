...
public class QiandaoController extends BaseMobileController{
	...
	public void index(){
		QiandaoParamDto qiandaoParamDto = new QiandaoParamDto(getSellerId(), getPageNo());
		qiandaoParamDto.setSeller(sellerUserService.findById(getSellerId()));
	...
	public void submit(){
		try {
			QiandaoSubmitParamDto qiandaoSubmitParamDto = new QiandaoSubmitParamDto(getSellerId(), 0);
			qiandaoSubmitParamDto.setQiandaoId(getParaToLong("qiandaoId"));
			qiandaoSubmitParamDto.setBuyer(getBuyerUser());
			qiandaoSubmitParamDto.setSeller(sellerUserService.findById(getSellerId()));
