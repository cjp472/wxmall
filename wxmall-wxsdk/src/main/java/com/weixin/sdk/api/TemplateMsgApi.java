...
public class TemplateMsgApi {
	...
	public static String getTemplateId(String tempShortId, String jsonStr){
		String templateId = accessTokenCache.get("template_msg_id_" + tempShortId);
		if(StringUtils.isBlank(templateId)){
			...
			accessTokenCache.set("template_msg_id_" + tempShortId, templateId);
		}
		return templateId;
	}
	...
	public static void main(String[] args) {
		...
		String templateId = TemplateMsgApi.getTemplateId("TM00785", json.toString());
		...
		TemplateData templateData = TemplateData.New().setTemplate_id(templateId)
			...
			.setUrl("http://m.ybwqy.com/pay/luck")
		...
		for(int i=0;i<30;i++){
			templateId = TemplateMsgApi.getTemplateId("TM00785", json.toString());
